...
COMPLIANCE_PATTERNS: Final[Dict[str, str]] = {"jitter": "PRBS31", "eye": "PRBS13", "levels": "PRBS7", "isi": "SQWV"}
...
def calculate_ui_parameters(symbol_rate: float = PAM4Specs.SYMBOL_RATE) -> Tuple[float, float]:
    """
