...
class MockInstrumentController:
    ...
    def __init__(self) -> None:
        ...
        self.responses = {"*IDN?": "Mock Instrument", "*RST": "OK", "MEASure:VOLTage:DC?": "0.123", "*TST?": "0", "*OPC?": "1"}
...
class TestTestSequencer(unittest.TestCase):
    ...
    def test_error_handling(self) -> None:
        ...
        with self.assertRaises(ValueError):
            self.test_sequencer.collect_and_analyze_data("INVALID::RESOURCE", "MEASure:VOLTage:DC?", "voltage")
