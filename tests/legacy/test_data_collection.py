...
class MockController:
    ...
    def _validate_resource_name(self, resource_name: str) -> None:
        ...
        if not any(resource_name.startswith(prefix) for prefix in valid_prefixes):
            raise ValueError(f"Invalid resource name format: {resource_name}. " f"Must start with one of: {valid_prefixes}")
...
class TestDataCollector(unittest.TestCase):
    ...
    def test_connect_instrument(self) -> None:
        ...
        self.assertTrue(self.test_resource in self.mock_controller.connected_instruments)
    ...
    def test_collect_data(self) -> None:
        ...
        response = self.data_collector.collect_data(self.test_resource, "MEASure:VOLTage:DC?")
    ...
    def test_disconnect_instrument(self) -> None:
        ...
        self.assertNotIn(self.test_resource, self.mock_controller.connected_instruments)
